...
export class SetField1618250396980 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("CREATE TABLE `set_field` (`id` int NOT NULL AUTO_INCREMENT, `fieldNumber` int NOT NULL, `restrictRing` int NULL, `restrictField` int NULL, `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP(), `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP(), `tileSetId` int NULL, `boardTileId` int NULL, INDEX `IDX_e3760feebe22dee5d2d2589c3d` (`id`, `fieldNumber`), UNIQUE INDEX `REL_735f650db06db1a69f53bfe46c` (`boardTileId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
